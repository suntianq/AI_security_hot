"""GitHub releases parser — release RawItem → NormalizedDocument."""
...
class GitHubReleasesParser(Parser):
    version = "github-releases-v1"
    ...
    def parse(self, raw: RawItem) -> NormalizedDocument:
        ...
        return NormalizedDocument(
            ...
            title_original=title.strip() or raw.native_id,
            ...
            parse_quality=score_parse_quality(
                ...
                body_text=body,
                min_body_len=1,  # releases can have short/empty bodies
            ),
        )
